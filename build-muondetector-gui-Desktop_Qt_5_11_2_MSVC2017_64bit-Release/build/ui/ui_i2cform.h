...
public:
    ...
    void setupUi(QWidget *I2cForm)
    {
        if (I2cForm->objectName().isEmpty())
            I2cForm->setObjectName(QStringLiteral("I2cForm"));
        ...
        nrDevicesLabel->setObjectName(QStringLiteral("nrDevicesLabel"));

        verticalLayout->addWidget(nrDevicesLabel);

        bytesReadLabel = new QLabel(statisticsGroupBox);
        bytesReadLabel->setObjectName(QStringLiteral("bytesReadLabel"));

        verticalLayout->addWidget(bytesReadLabel);

        bytesWrittenLabel = new QLabel(statisticsGroupBox);
        bytesWrittenLabel->setObjectName(QStringLiteral("bytesWrittenLabel"));
        ...
        devicesGroupBox->setObjectName(QStringLiteral("devicesGroupBox"));
        ...
        devicesTableWidget->setObjectName(QStringLiteral("devicesTableWidget"));
        ...
        statsQueryPushButton->setObjectName(QStringLiteral("statsQueryPushButton"));

        gridLayout_3->addWidget(statsQueryPushButton, 2, 0, 1, 1);

        scanBusPushButton = new QPushButton(I2cForm);
        scanBusPushButton->setObjectName(QStringLiteral("scanBusPushButton"));
